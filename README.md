# XML-Parser
A WIP script that extracts publication data from the Cancer Imaging Archive publication list (last updated May 2018) and formats it into HTML. Requires the `bs4` module and the lxml tree builder, you can install them by doing `pip install bs4` and `pip install lxml`.
