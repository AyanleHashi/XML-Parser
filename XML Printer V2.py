#Updated to work with all versions of Pubs_basedon_TCIA----
import xmltodict
import csv
...
outputWriter.writerow(['Authors:', 'Titles:', 'Periodicals:', 'Years:'])
try:
    for record in range(0,len(doc['xml']['records']['record'])):
        outputWriter.writerow([doc_authors[record], doc_title[record], doc_periodical[record], doc_year[record]])
except IndexError:
